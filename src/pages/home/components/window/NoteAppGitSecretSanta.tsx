...
function Content() {
  return (
    <div className={classes.text}>
      ...
      />
      <p>
        Assigns recipients for a "Secret Santa" gift exchange, allowing all
        members of a group to participate without anyone knowing the
        assignments.
      </p>
      <p>
...
export default function NoteAppGitSecretSanta() {
  return <Window title="Secret Santa's Helper" content={<Content />} />;
}
